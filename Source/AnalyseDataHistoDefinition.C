...
TH2F *hthXinScinP= new TH2F("hthXinScinP","Scintillator VS X in-going angle (#theta_{x,in}); Horizontal Incoming Angle [#murad]; Scintillator",thXinBin,-thXin+0.5,thXin+0.5,100,0,20000);
TH2F *hthYinScinP= new TH2F("hthYinScinP","Scintillator VS Y in-going angle (#theta_{y,in}); Vertical Incoming Angle [#murad]; Scintillator",thXinBin,-thYin+0.5,thYin+0.5,100,0,20000);
